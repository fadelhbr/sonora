      ...
      release = {
        ...
        assets = {
          x86_64-linux = {
            ...
            hash = "sha256-27kMtd5ffEkkVwNX5SUd7TBiG7/DdnHc4JcDiIIc7IE=";
          };
          aarch64-linux = {
            target = "aarch64-unknown-linux-gnu";
            hash = "sha256-YhXBfbMMsbmK2P3eMsiATtocpxN5gx7bIUeoGdJI3RQ=";
          };
          aarch64-darwin = {
            target = "macos";
            hash = "sha256-q9+Md1vUBUCfPiXnlqZkBMsh7ziI4V2SUNnrjdSFUnA=";
          };
        };
      };
    in
